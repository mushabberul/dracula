                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="forgot_password_post.php">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" name="email" id="email" placeholder="Enter Email Address...">
                                            <?php if (isset($_SESSION['forget_password_err'])) : ?>
                                                <small class="text-danger"><?php echo $_SESSION['forget_password_err']; ?></small>
                                            <?php
                                            endif;
                                            unset($_SESSION['forget_password_err']);
                                            ?>
                                            <?php if (isset($_SESSION['forget_password_wrong_err'])) : ?>
                                                <small class="text-danger"><?php echo $_SESSION['forget_password_wrong_err']; ?></small>
                                            <?php
                                            endif;
                                            unset($_SESSION['forget_password_wrong_err']);
                                            ?>
                                        </div>
